    ...
    <>
      <div className="list-item">
        <div className="list-item-link" onClick={() => handleOnToggle()}>
          ...
          <div className="list-spots">{props.spots}</div>
          {/* prettier-ignore */}
        ...
        <div className="modal-container">
          <div className="modal modal-width--normal">
            ...
            <form className="grid">
              ...
              <DaySelector />
              <div className="form-field">
                <label>E-postadresse og kjøretøy</label>
                {/* prettier-ignore */}
                <span>Personen har en aktiv Parkly-bruker (<b>navn.navnesen123@gmail.com</b>), og administrerer selv sin tildeling. Du kan ikke lenger se eller endre kjøretøy for denne brukeren.</span>
              </div>
              <div className="form-field">
